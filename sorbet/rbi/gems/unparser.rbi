...
class Unparser::AST::Walker
  ...
  include Anonymous_Unparser_Concord_8
end
module Anonymous_Unparser_Concord_8
  def block; end
  def controller; end
  def initialize(*args); end
  include Anonymous_Unparser_Equalizer_9
  include Unparser::Equalizer::Methods
end
module Anonymous_Unparser_Equalizer_9
...
class Unparser::Emitter
  ...
  extend Unparser::Adamantium::ModuleMethods
  extend Unparser::DSL
  include Anonymous_Unparser_Anima_11
...
module Anonymous_Unparser_Anima_11
end
...
class Unparser::Emitter::Root < Unparser::Emitter
  ...
  def local_variable_scope(&block); end
  def node; end
  include Anonymous_Unparser_Concord_Public_12
  include Unparser::Emitter::LocalVariableRoot
end
module Anonymous_Unparser_Concord_Public_12
  def buffer; end
  def comments; end
  def initialize(*args); end
  def node; end
  include Anonymous_Unparser_Equalizer_13
  include Unparser::Equalizer::Methods
end
module Anonymous_Unparser_Equalizer_13
  def cmp?(comparator, other); end
  def hash; end
  def inspect; end
end
...
class Unparser::Writer::Binary
  ...
  extend Unparser::Adamantium::ModuleMethods
  extend Unparser::DSL
  include Anonymous_Unparser_Anima_15
...
module Anonymous_Unparser_Anima_15
end
...
class Unparser::CLI::Target::Path < Unparser::CLI::Target
  ...
  def validation; end
  include Anonymous_Unparser_Concord_24
end
module Anonymous_Unparser_Concord_24
  def initialize(*args); end
  def path; end
  include Anonymous_Unparser_Equalizer_25
  include Unparser::Equalizer::Methods
end
module Anonymous_Unparser_Equalizer_25
  def cmp?(comparator, other); end
  def hash; end
  def inspect; end
end
